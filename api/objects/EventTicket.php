<?php
/*
 * The seminar ticket/packages will be hard coded on the homepage with a unique ID that will be stored in the DB and a registered sponsor will select and the 
 ...
 * */
    ...
    class EventTicketInfo
    {
        ...
        public $date;                   // Date evetn ticket was created 
    }
    
    
    class EventTicket extends EventTicketInfo
    {
     
        // database connection and table name
        private $conn;
        private $table_name = DB_EVENT_TICKET_TBL;
        private $fmt;
