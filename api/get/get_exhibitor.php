<?php
    ...
    include_once '../objects/exhibitor.php';
    ...
    $result = isset($_GET['id']) ? $user->readByExhibitorId($_GET['id']) : $user->readAll();
    ...
    if(false != $result)
    {
        ...
        while ($row = mysqli_fetch_assoc($result)){
           ...
           // extract($row);
            ...
            $userInfo = new ExhibitorInfo();
            
            $userInfo->id    = $row['id'];
            $userInfo->exhibitor_id= $row['exhibitor_id'];
