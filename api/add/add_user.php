<?php
    ...
    $user->reg_id            = md5((string)time()); // htmlspecialchars(strip_tags($data->reg_id));
    ...
    $user->tel               = htmlspecialchars(strip_tags($data->tel));
    $user->cell              = htmlspecialchars(strip_tags($data->cell));
